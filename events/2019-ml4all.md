...
<!--====================================
<section>
<iframe class="stretch" src="http://localhost:8888/notebooks/deutsch-jozsa-demo.ipynb"></iframe>
</section>
==============================================-->
<!--==================================================================================-->
...
<section data-markdown>
  <script type="text/template">
  ### How do I know if I should use quantum resources for my problem? ###
  <div class="fragment"><em>There are no easy rules...</em>😭</div>
  </script>
</section>
...
<section data-markdown>
    <script type="text/template">
    ### Near-term quantum computers can help with:###
    <ul>
      <li><p class="fragment"> Problems that have a "simple" output</p>
        <ul>
            <li><p class="fragment"> We can't just directly read out the entire state</p></li>
        </ul>
      </li>
      <li><p class="fragment"> Problems with small amounts of input/output</p>
        <ul>
            <li><p class="fragment"> Qubits are too $$$ to store classical data </p></li>
        </ul>
      </li>
      <li><p class="fragment"> Problems with lots of intermediate calculations that you don't care about</p>
        <ul>
            <li><p class="fragment"> QC can express less powerful operations </p></li>
        </ul>
      </li>
    </ul>
    </script>
...
## Asking Less is More ##
<ul>
    <li><p class="fragment">Quantum resources are not necessarily faster or better, but by asking the right questions you can play to the strengths of the technology!</p></li>
</ul>
</script>
</section>
...
_How can we apply quantum algorithms to accelerate ML?_
</script>
</section>
...
## Short answer: 🤔 ##
<ul>
<li><p class="fragment"> Most known quantum machine learning algorithms make great <text style="color:#008B8B">_subroutines_</text> in larger algorithms </p></li>
<li><p class="fragment"> We need structure for problems that does not blow away advantages of translating between classical and quantum</p></li>
</ul>
</script>
</section>
...
<text class="fragment" style="color:#008B8B">HHL can do this in exponentially less time than a classical computer</text>
...
<section data-markdown>
<script type="text/template">
###<div style="color:#008B8B">HHL Algorithm</div>###
**Solve:**  $~A\cdot|x\rangle = |b\rangle$

With some conditions* on $A$,

$|x\rangle = A^{-1}\cdot|b\rangle$

<div class="fragment">Great, but now what do we do with $|x\rangle$? We can't just read every value out... </div>
...
###<div style="color:#008B8B">HHL Algorithm</div>###
$|x\rangle = A^{-1}\cdot|b\rangle$
- If you try to read out $|x\rangle$, you will need multiple copies; overall $\log$ *worse* than classical!
- Either we have to make $|x\rangle$ low dimension, or only want to know some restricted information about $|x\rangle$

<small><em>For an example application of HHL, see [Quantum Algorithm for Data Fitting](https://doi.org/10.1103/PhysRevLett.109.050505).</em></small>
</script>
</section>
...
<!--=======================================
<section>
<iframe class="stretch" src="http://localhost:8888/notebooks/quantum-perceptron-python.ipynb"></iframe>
</section>
===========================================-->
...
<p class="fragment"><a href="https://math.nist.gov/quantum/zoo/">More on QML from Quantum Model Zoo</a></p>

</section>

<!--									<ul class="square">
          <li><p class="fragment">Need to figure out how to use quantum computers like GPUs for targeted acceleration</p></li>
          <li><p class="fragment">Also need to reduce translation/encoding costs for representing the problem in qubits</p></li>
      </ul>-->
<!--==================================================================================-->
...
#### I CHOOSE YOU! ####
## Deutsch–Jozsa ##
<!--<video data-src="https://media.giphy.com/media/HQuZn367GgytO/giphy.mp4" alt="Misty from Pokemon throwing a pokeball" style="width: 45%;" autoplay/>-->
...
<!--<img data-src="/static/img/dwave-fail.jpg" alt="Sarah in an award-winning halloween costume which is a big black box that looks like a DWAVE machine" style="width: 80%;"/>-->
